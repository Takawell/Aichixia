...
const AVAILABLE_MODELS = [
  ...
  },
  {
    ...
    category: 'Text Generation',
    requiresPlan: 'pro',
    description: 'High-efficiency MoE architecture utilizing 28B active parameters out of 114B for ultra-fast inference without compromising intelligence.',
    speed: 5,
    quality: 5,
  ...
  },
  {
    ...
    pricing: 'Premium',
    features: ['Advanced Coding', 'Agentic Workflows', 'Deep Reasoning', 'Artifacts Ready'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
  ...
  },
  {
    ...
    description: 'Mythos-class model built for the most demanding reasoning and long-horizon agentic work',
    speed: 4,
    quality: 5,
    contextWindow: '1M tokens',
    pricing: 'Premium',
    features: ['Long-horizon agents', 'Vision', 'Deep reasoning', 'Enterprise-grade'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
    ...
    contextWindow: '200k tokens',
    pricing: 'Standard',
    features: ['Fast responses', 'Everyday tasks', 'Cost-efficient'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
  ...
  },
  {
    ...
    pricing: 'Budget',
    features: ['Multimodal', 'Vision', 'Audio', 'Lightweight'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
    id: 'z-ai/glm-5.2',
  ...
  },
  {
    ...
    pricing: 'Standard',
    features: ['Fast inference', 'Efficient', 'General purpose'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
    ...
    contextWindow: '128K tokens',
    pricing: 'Budget',
    features: ['Open weights', 'Efficient', 'General purpose'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
  ...
  },
  {
    ...
    category: 'Text Generation',
    requiresPlan: 'pro',
    description: 'Long-horizon agentic coding model built by Poolside for software engineering workflows.',
    speed: 4,
    quality: 5,
    contextWindow: '256K tokens',
    pricing: 'Premium',
    features: ['Agentic coding', 'Long-horizon tasks', 'Tool calling'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
  ...
  },
  {
    ...
    category: 'Text Generation',
    requiresPlan: 'pro',
    description: 'Fast multimodal model with strong reasoning and agentic workflow support',
    speed: 5,
    quality: 4,
    contextWindow: '128K tokens',
    pricing: 'Standard',
    features: ['Fast inference', 'Multimodal', 'Reasoning'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
    ...
    category: 'Text Generation',
    requiresPlan: 'pro',
    description: 'Multimodal reasoning model with switchable reasoning and tool use',
    speed: 3,
    quality: 4,
    contextWindow: '256K tokens',
    pricing: 'Premium',
    features: ['Vision', 'Reasoning', 'Tool use'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
    ...
    category: 'Text Generation',
    description: 'Fast MoE model built for long-context tasks',
    speed: 5,
    quality: 4,
    contextWindow: '131K tokens',
    pricing: 'Standard',
    features: ['MoE Architecture', 'Instruction Tuned', 'Multimodal'],
    endpoint: 'https://www.aichixia.xyz/api/v1/chat/completions',
  },
  {
  ...
  },
  {
    ...
    category: 'Text Generation',
    requiresPlan: 'pro',
    description: 'Xiaomi flagship model strong general agentic capabilities, complex software engineering, and long-horizon tasks.',
    speed: 5,
    quality: 5,
    contextWindow: '1M tokens',
    pricing: 'Premium',
  ...
  },
  {
    ...
    requiresPlan: 'pro',
    description: 'Image-to-video generation with cinematic motion from Alibaba Wan series',
    speed: 3,
    quality: 4,
    contextWindow: 'N/A',
    pricing: 'Premium',
    features: ['Image-to-video', 'Cinematic motion', 'Fast generation'],
  ...
  },
  {
    ...
    category: 'Video Generation',
    requiresPlan: 'pro',
    description: 'State of the art video generation with fully synchronized soundtrack from MiniMax',
    speed: 3,
    quality: 5,
    contextWindow: 'N/A',
    pricing: 'Premium',
