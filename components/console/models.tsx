...
import { FiCopy, FiCheck, FiLock, FiZap, FiCpu, FiTrendingUp, FiDollarSign, FiSearch, FiStar, FiInfo } from 'react-icons/fi';
...
const AVAILABLE_MODELS = [
  ...
  },
  {
    ...
    category: 'Standard',
    description: 'Balanced performance for general-purpose applications',
    speed: 3,
    quality: 4,
    contextWindow: '64K tokens',
    pricing: 'Standard',
    features: ['Versatile', 'Multimodal', 'Reliable'],
  },
  {
    id: 'kimi-k2',
    name: 'Kimi K2',
  ...
  },
  {
    ...
    category: 'Fast',
    description: 'Compact version with faster inference times',
    speed: 4,
    quality: 4,
    contextWindow: '64K tokens',
    pricing: 'Standard',
    features: ['Quick responses', 'Efficient', 'Cost-effective'],
  },
];
          ...
          <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-1 scrollbar-thin scrollbar-thumb-zinc-300 dark:scrollbar-thumb-zinc-700">
            {categories.map((cat) => (
              <button
                ...
                className={`px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg font-semibold text-[10px] sm:text-xs whitespace-nowrap transition-all ${
