...
const VISION_MODEL_IDS = new Set(['gpt-5.2', 'kimi-k2.6', 'gemini-3-flash', 'aichixia-flash', 'grok-4-fast', 'phi-4-multimodal-instruct', 'qwen3.6-27b']);
...
const TEXT_MODELS: AnyModel[] = [
  ...
  { id: 'qwen3.6-27b', name: 'Qwen3.6 27B', provider: 'Alibaba', icon: SiMatternet, color: 'from-purple-500 to-pink-500', pricing: 'Standard', context: '256K', type: 'text', endpoint: `${base}/api/v1/chat/completions`, requiresPro: true },
