...
const deprecatedModels: DeprecatedModel[] = [
  ...
  { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', provider: 'Anthropic', icon: SiAnthropic, replacement: 'Claude Sonnet 4.6', reason: 'Claude Haiku 4.5 has been retired now that Claude Sonnet 4.6 is available, offering deeper reasoning, stronger coding ability, and better agentic workflows at a similar response speed.', removedOn: 'May 18, 2026', color: 'from-orange-400 to-amber-500' },
  { id: 'qwen3-235b', name: 'Qwen3 235B', provider: 'Alibaba', icon: SiAlibabacloud, replacement: 'Qwen3.6 27B', reason: 'Qwen3 235B has been retired now that Qwen3.6 27B is available, delivering comparable multimodal and multilingual reasoning with a much smaller footprint and faster inference.', removedOn: 'April 2, 2026', color: 'from-purple-500 to-pink-500' },
  { id: 'minimax-m2-1', name: 'MiniMax M2.1', provider: 'MiniMax', icon: SiMaze, replacement: 'MiniMax M2.7', reason: 'MiniMax M2.1 has been retired now that MiniMax M2.7 is available, bringing improved coding, creative, and analytical performance with better agent workflow support.', removedOn: 'March 14, 2026', color: 'from-cyan-600 to-blue-600' },
  { id: 'kimi-k2', name: 'Kimi K2', provider: 'Moonshot AI', icon: SiDigikeyelectronics, replacement: 'Kimi K2.6', reason: 'Kimi K2 has been retired now that Kimi K2.6 is available, offering stronger tool calling, more reliable long-context handling, and better complex reasoning.', removedOn: 'February 27, 2026', color: 'from-blue-600 to-cyan-600' },
  { id: 'mistral-3-1', name: 'Mistral 3.1', provider: 'Mistral AI', icon: TbLetterM, replacement: 'Mistral Large 3 675B', reason: 'Mistral 3.1 has been retired now that Mistral Large 3 675B is available, providing stronger reasoning, better multilingual coverage, and improved open-weight performance.', removedOn: 'February 5, 2026', color: 'from-orange-500 to-amber-600' },
  { id: 'deepseek-v3-1', name: 'DeepSeek V3.1', provider: 'DeepSeek', icon: GiSpermWhale, replacement: 'DeepSeek V4 Flash', reason: 'DeepSeek V3.1 has been retired now that DeepSeek V4 Flash is available, offering a much larger context window and more consistent, cost-effective performance.', removedOn: 'January 21, 2026', color: 'from-cyan-600 to-blue-600' },
  ...
  { id: 'gpt-4-mini', name: 'GPT-4 Mini', provider: 'OpenAI', icon: RiOpenaiFill, replacement: 'GPT-5 Mini', reason: 'GPT-4 Mini has been retired now that GPT-5 Mini is available, offering better balanced performance for general tasks at a similarly budget-friendly cost.', removedOn: 'December 12, 2025', color: 'from-emerald-600 to-green-600' },
];
