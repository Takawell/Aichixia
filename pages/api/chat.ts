...
const PROVIDER_CAPABILITIES: Record<ProviderType, ProviderCapability> = {
  ...
  qwen: {
    ...
    rateLimit: 60,
    bestFor: ["coding", "chinese language", "asian languages", "technical writing", "multilingual code", "algorithm implementation", "competitive programming", "math problems", "chinese tech stack", "mandarin documentation", "mathematics", "algebra", "geometry", "number theory", "discrete math", "calculus", "statistics", "probability theory", "mathematical proofs"],
  ...
  openai: {
    ...
    hasSearch: false,
    contextWindow: 128000,
    specialties: ["conversation", "creative", "webdev", "fullstack", "general"],
    rateLimit: 90,
    bestFor: ["general purpose", "balanced tasks", "creative writing", "conversation", "web development", "javascript", "typescript", "react", "nodejs", "api integration", "general coding", "tutorials", "explanations", "homework help", "tutoring", "education", "learning", "problem solving", "brainstorming", "ideation"],
  ...
  llama: {
    ...
    hasSearch: true,
    contextWindow: 128000,
    specialties: ["conversation", "greeting", "webdev", "general"],
    rateLimit: 150,
  ...
  glm: {
    ...
    hasSearch: false,
    contextWindow: 128000,
    specialties: ["multilingual", "conversation", "chinese", "translation"],
    rateLimit: 60,
    bestFor: ["chinese language", "multilingual", "conversation", "translation", "chinese coding", "mandarin support", "asian languages", "localization", "chinese entertainment", "chinese culture", "chinese literature"],
