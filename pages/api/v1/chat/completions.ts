...
import { chatScout, streamScout, ScoutRateLimitError, ScoutQuotaError } from "@/lib/scout";
...
const MODEL_MAPPING: Record<string, { fn: ChatFunction; provider: string }> = {
  ...
  "deepseek/deepseek-v4.1-flash": { fn: chatDeepSeekV, provider: "deepseek-v" },
  ...
  "google/gemini-3.8-flash": { fn: chatGemini, provider: "gemini" },
...
const STREAM_MODEL_MAPPING: Record<string, StreamFunction> = {
  ...
  "deepseek/deepseek-v4.1-flash": streamDeepSeekV,
  ...
  "google/gemini-3.8-flash": streamGemini,
