...
const LOCKED_MODELS_PRO = ['deepseek-v3.2', 'minimax-m3', 'qwen3-coder-480b', 'claude-sonnet-4.6', 'glm-5.2', 'aichixia-flash', 'grok-4-fast', 'kimi-k2.6', 'gpt-5.2', 'gpt-5.5', 'laguna-s-2.1', 'claude-opus-4.8'];
