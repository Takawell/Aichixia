      ...
      <div className="relative w-full mx-auto max-w-3xl">
        <main className="relative overflow-hidden">
          ...
          <div className="my-6 flex items-center justify-center gap-1">
            ...
            <p className="text-xs text-yellow-500">Maintenance in progress</p>
          </div>
          <p className="text-center text-white/40 text-xs md:text-sm">
            Need help? Contact us at{" "}
            <a href="mailto:contact@aichixia.xyz" className="text-white/70 hover:text-white transition-colors">
