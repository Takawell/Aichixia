...
export default function Home() {
  ...
  return (
    <>
      ...
      {showContactModal && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/75 backdrop-blur-lg"
          onClick={() => { setShowContactModal(false); setContactStep('confirm'); }}
        >
          <div
            className="relative bg-white dark:bg-zinc-950 rounded-2xl shadow-2xl border border-zinc-200 dark:border-zinc-800 w-full max-w-sm overflow-hidden"
              ...
              {contactStep === 'confirm' ? (
                <div className="space-y-5">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 mb-3">
                      <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-zinc-800 to-zinc-900 dark:from-zinc-700 dark:to-zinc-800 flex items-center justify-center shadow-inner">
                        <FaUsers className="w-3.5 h-3.5 text-zinc-300" />
                      </div>
                      <span className="text-[10px] font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">Enterprise Sales</span>
                    </div>
                    <h3 className="text-xl sm:text-2xl font-black text-zinc-900 dark:text-white leading-tight">Contact Our Team</h3>
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                      Are you sure you want to reach out to the Aichixia team? We'll get back to you within 24 hours.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                    <div className="w-9 h-9 rounded-lg bg-zinc-900 dark:bg-zinc-800 flex items-center justify-center flex-shrink-0">
                      <FaGlobe className="w-4 h-4 text-zinc-400" />
                    </div>
                    <div>
                      <p className="text-[10px] font-semibold text-zinc-500 dark:text-zinc-500 uppercase tracking-wider mb-0.5">Contact Email</p>
                      <p className="text-sm font-bold text-zinc-800 dark:text-zinc-200 font-mono">contact@aichixia.xyz</p>
                    </div>
                  </div>

                  <ul className="space-y-2">
                    {['Custom pricing & contracts', 'Dedicated infrastructure', '24/7 priority support'].map((item) => (
                      <li key={item} className="flex items-center gap-2.5 text-xs text-zinc-600 dark:text-zinc-400">
                        <FaCheckCircle className="w-3.5 h-3.5 text-zinc-400 dark:text-zinc-600 flex-shrink-0" />
                        {item}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="space-y-5 text-center py-2">
                  <div className="relative mx-auto w-16 h-16">
                    <div className="absolute inset-0 rounded-2xl bg-emerald-500/20 dark:bg-emerald-500/10 blur-xl" />
                    <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-400 to-green-500 flex items-center justify-center shadow-lg shadow-emerald-500/25">
                      <FaCheckCircle className="w-7 h-7 text-white" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-xl font-black text-zinc-900 dark:text-white">Email Client Opened</h3>
                    <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed max-w-xs mx-auto">
                      Complete the email to <span className="font-semibold text-zinc-700 dark:text-zinc-300">contact@aichixia.xyz</span>. Our team will respond within 24 hours.
                    </p>
                  </div>
                  <button
                    onClick={() => { setShowContactModal(false); setContactStep('confirm'); }}
                    className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-zinc-900 dark:bg-white dark:text-zinc-900 hover:opacity-90 rounded-xl shadow-lg transition-all duration-200 hover:scale-105"
                  >
