    ...
    <>
      ...
      <section className="relative py-20 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-zinc-950 via-zinc-900 to-black shadow-[0_0_120px_rgba(59,130,246,0.15)]">
            <div className="absolute inset-0 opacity-30">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.35),transparent_35%)]"></div>
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_right,rgba(168,85,247,0.35),transparent_35%)]"></div>
            </div>

            <div className="relative grid lg:grid-cols-2 gap-12 items-center p-8 sm:p-12 lg:p-16">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-cyan-400/20 bg-cyan-500/10 backdrop-blur-xl">
                  <div className="relative flex items-center justify-center">
                    <div className="absolute w-3 h-3 bg-cyan-400 rounded-full animate-ping"></div>
                    <div className="relative w-3 h-3 bg-cyan-400 rounded-full"></div>
                  </div>

                  <span className="text-xs font-black tracking-[0.25em] uppercase text-cyan-300">
                    Breaking News
                  </span>
                </div>

                <div className="space-y-5">
                  <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-[0.95] tracking-tight text-white">
                    Meet
                  ...
                  <p className="text-base sm:text-lg text-zinc-400 leading-relaxed max-w-2xl">
                    The next generation AI coding environment is arriving soon with ultra-fast workflows, advanced agent execution, deep terminal integration, smart context understanding, and a fully immersive developer experience.
                  </p>
                </div>

                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 hover:bg-white/10 transition-all duration-500">
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      Execute commands instantly with fully interactive AI-powered terminal workflows.
                    </p>
                  </div>

                  <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 hover:bg-white/10 transition-all duration-500">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shadow-lg shadow-purple-500/30">
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      Advanced AI agents capable of planning, coding, debugging, and executing tasks seamlessly.
                    </p>
                  </div>

                  <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 hover:bg-white/10 transition-all duration-500">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-lg shadow-emerald-500/30">
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      Built for ultra-low latency interactions with smooth streaming and instant responses.
                    </p>
                  </div>
                  ...
                  <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-5 hover:bg-white/10 transition-all duration-500">
                    ...
                    <p className="text-sm text-zinc-400 leading-relaxed">
                      Understands large projects instantly with contextual awareness across files and systems.
                    </p>
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="group relative overflow-hidden px-7 py-4 rounded-2xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white font-bold shadow-2xl shadow-cyan-500/20 hover:scale-[1.03] transition-all duration-500">
                  ...
                  <button className="px-7 py-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl text-white font-semibold hover:bg-white/10 transition-all duration-500">
                    Explore Preview
                  </button>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="relative rounded-[28px] border border-white/10 bg-black/60 backdrop-blur-2xl overflow-hidden shadow-[0_0_80px_rgba(59,130,246,0.15)]">
                    ...
                    <div className="space-y-5">
                      <div className="flex items-center gap-3 text-sm">
                        ...
                        <span className="text-zinc-300">
                          initializing axcode environment...
                        </span>
                      </div>

                      <div className="space-y-3">
                        <div className="h-2 rounded-full bg-zinc-800 overflow-hidden">
                          <div className="h-full w-[92%] bg-gradient-to-r from-cyan-500 to-blue-500 animate-pulse rounded-full"></div>
                        </div>

                        <div className="h-2 rounded-full bg-zinc-800 overflow-hidden">
                          <div className="h-full w-[84%] bg-gradient-to-r from-purple-500 to-pink-500 animate-pulse rounded-full"></div>
                        </div>

                        <div className="h-2 rounded-full bg-zinc-800 overflow-hidden">
                          <div className="h-full w-[97%] bg-gradient-to-r from-emerald-500 to-green-500 animate-pulse rounded-full"></div>
                        </div>
                      </div>
                      ...
                      <div className="mt-6 rounded-2xl border border-cyan-500/20 bg-cyan-500/10 p-4">
                        ...
                        <p className="text-sm text-zinc-300 leading-relaxed">
                          AxCode is entering the final development phase and will launch publicly very soon.
                        </p>
                      </div>
                    </div>
                  </div>
